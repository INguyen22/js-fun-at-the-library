...
var title = "Heaven's Official Blessing"
var pageCount = 389
...
pages = pageCount * 0.25

console.log(pages)
//This should log the result of 97.25
...
var sequel = `${title} sequel is ${title} 2`
...
//this should log the result of false
...
var books = ['A man and his cat', 'Cat massage therapy', 'Cat butler', 'Cat basics', 'Organic Chemistry vol.3']
